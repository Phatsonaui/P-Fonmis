...
<div class="container-fluid pb-4" style=" color: #000000; background-color:#d8d6d6;">
    <div class="row g-3 mt-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" id="activet" aria-current="page">บริการวิชาการ</li>
            </ol>
        </nav>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-12 mt-5">
            <div class="kpi-card">
                <div class="flex-container-rounded mb-3">
                    <h1 style="font-weight: 700;">สรุปภาพรวมบริการวิชาการ</h1>
                </div>
                    ...
                    <div class="kpi-card">
                        <div class="card-body">
                            <div class="row"> <!-- style="align-items: center;" -->
                                <div id="Prothum" style="width: 100%; height: 400px;border-radius: 10px; overflow: hidden;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="kpi-card">
                        <div class="card-body">
                            <div class="row"> <!-- style="align-items: center;" -->
                                <div id="Perthum" style="width: 100%; height: 400px;border-radius: 10px; overflow: hidden;"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12 mt-5">
            <div class="kpi-card">
                <div class="flex-container-rounded mb-3">
                    <h1 style="font-weight: 700;">โครงการ (<span id="pro_thum"></span>)</h1>
                    <div class="col-md-3">
                ...
                <div class="content-card_plan">
                    ...
                    <div class="content-card">
                        ...
                        <div class="kpi-card">
                            <div class="card-body">
                                <div class="flex-container-rounded">
                                    <p class="card-text"><i class="bi bi-journals"></i> ROI </p>
                                    <p class="rounded-full success-full"></p>
                                </div>
                                <div class="row">
                                    <div class="d-flex justify-content-around">
                                        <h1 class="card-title" id="pro_roi"></h1>
                                    </div>
                                </div>
                                <div class="flex-container-rounded justify-content-end">
                                    <p>%</p>
    ...
    function fetchData(year) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                animateMoney('#pro_roi', 0, data.roi || 0, 3000);
                ...
                const allProjectIds = data.allProjectIds;
                const serProjectIds = data.serProjectIds;
                ...
                myChart.on('click', function(params) {
                    ...
                    if (params.name === "โครงการบริการวิชาการ") {
                        selectedProjectIds = serProjectIds;
        ...
        $.ajax({
            type: "POST",
            url: 'config/get_g_Ser.php',
            data: {
                year: year
            },
            success: function(data) {
                var chartDom1 = document.getElementById('Prothum');
                var myChart1 = echarts.init(chartDom1, 'vintage');
                var option1;
                ...
                option1 = {
                    ...
                    tooltip: {
                        ...
                        formatter: function(params) {
                            let content = `<b style="color:#000">${params[0].value.Year}</b><br/>`; // ใช้ชื่อห้องเป็นชื่อหลัก
                    ...
                    dataset: {
                        dimensions: ['Year', 'จำนวนทั้งหมด', 'กำลังใช้งาน', 'ว่าง'],
                        source: [{
                                Year: '2567',
                                'จำนวนทั้งหมด': data.project_67
                            },
                            {
                                Year: '2568',
                                'จำนวนทั้งหมด': data.project_68
                            },
                        ]
                    },
                    xAxis: {
                ...
                // กราฟบุคลากรแยกรายปี
                var chartDom11 = document.getElementById('Perthum');
                var myChart11 = echarts.init(chartDom11, 'vintage');
                var option11;
                ...
                option11 = {
                    ...
                    tooltip: {
                        ...
                        formatter: function(params) {
                            let content = `<b style="color:#000">${params[0].value.Year}</b><br/>`;
                            params.forEach((param) => {
                                content += `<span style="color:${param.color}">${param.seriesName}</span>: ${param.data[param.seriesName]}<br/>`;
                            });
                            return content;
                        }
                    },
                    dataset: {
                        dimensions: [
                            ...
                            'เจ้าหน้าที่คณะพยาบาลศาสตร์',
                            'นิสิตคณะพยาบาลศาสตร์',
                            'นักวิจัย/นักวิชาการ',
                            'พยาบาล/บุคลากรทางสุขภาพ',
                            'ประชาชนในพื้นที่',
                            'ศิษย์เก่า',
                            'อื่น ๆ'
                        ],
                        source: [{
                                Year: '2567',
                                'อาจารย์คณะพยาบาลศาสตร์': data.Pers24_1,
                                'เจ้าหน้าที่คณะพยาบาลศาสตร์': data.Pers24_2,
                                'นิสิตคณะพยาบาลศาสตร์': data.Pers24_3,
                                'นักวิจัย/นักวิชาการ': data.Pers24_4,
                                'พยาบาล/บุคลากรทางสุขภาพ': data.Pers24_5,
                                'ประชาชนในพื้นที่': data.Pers24_6,
                                'ศิษย์เก่า': data.Pers24_7,
                                'อื่น ๆ': data.Pers24_99
                            },
                            {
                                Year: '2568',
                                'อาจารย์คณะพยาบาลศาสตร์': data.Pers25_1,
                                'เจ้าหน้าที่คณะพยาบาลศาสตร์': data.Pers25_2,
                                'นิสิตคณะพยาบาลศาสตร์': data.Pers25_3,
                                'นักวิจัย/นักวิชาการ': data.Pers25_4,
                                'พยาบาล/บุคลากรทางสุขภาพ': data.Pers25_5,
                                'ประชาชนในพื้นที่': data.Pers25_6,
                                'ศิษย์เก่า': data.Pers25_7,
                                'อื่น ๆ': data.Pers25_99
                            }
                        ]
                    },
                    xAxis: {
                    ...
                    series: [{
                            ...
                            encode: {
                                x: 'Year',
                                y: 'อาจารย์คณะพยาบาลศาสตร์'
                            }
                        },
                        {
                            type: 'bar',
                            name: 'เจ้าหน้าที่คณะพยาบาลศาสตร์',
                            color: "#d87c7c",
                            itemStyle: {
                                borderColor: '#d87c7c',
                                borderWidth: 2,
                            ...
                            encode: {
                                x: 'Year',
                                y: 'เจ้าหน้าที่คณะพยาบาลศาสตร์'
                            }
                        },
                        {
                            type: 'bar',
                            name: 'นิสิตคณะพยาบาลศาสตร์',
                            color: "#919e8b",
                            itemStyle: {
                                borderColor: '#919e8b',
                                borderWidth: 2,
                        ...
                        },
                        {
                            ...
                            encode: {
                                x: 'Year',
                                y: 'นักวิจัย/นักวิชาการ'
                            }
                        },
                        {
                            type: 'bar',
                            name: 'พยาบาล/บุคลากรทางสุขภาพ',
                            color: "#6e7074",
                            itemStyle: {
                                borderColor: '#6e7074',
                                borderWidth: 2,
                            ...
                            encode: {
                                x: 'Year',
                                y: 'พยาบาล/บุคลากรทางสุขภาพ'
                            }
                        },
                        {
                            type: 'bar',
                            name: 'ประชาชนในพื้นที่',
                            color: "#efa18d",
                            itemStyle: {
                                borderColor: '#efa18d',
                                borderWidth: 2,
