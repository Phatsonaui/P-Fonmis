					...
					<div class="row g-3">
						...
						<div class="col-md-12 relation text-center">
							...
							<div href="" class="circle " style="background-color: #F58518; margin-right: 50px;">
								<input class="Check_c me-1 as" type="checkbox" value="3" id="thirdCheckbox">
							...
							<div href="" class="circle " style="background-color: #E45756;margin-right: 30px;">
								<input class="Check_c me-1 as" type="checkbox" value="4" id="fourCheckbox">
			...
			<div class="card">
				<div class="card-body">
					<div class="row g-3">
						...
						<div class="col-md-12 relation text-center">
							<div href="" class="circle " style="background-color: #54A24B; margin-right: 50px;">
								<input class="Check_c me-1 ye" type="checkbox" value="ปกติ" id="firstCheckbox">
								<p style="color: #fff;font-weight: 800;margin-top: 9px;position: static;">ปกติ</p>
							</div>
							<div href="" class="circle " style="background-color: #4C78A8; margin-right: 50px;">
								<input class="Check_c me-1 ye" type="checkbox" value="Ep" id="secondCheckbox">
								<p style="color: #fff;font-weight: 800;margin-top: 9px;position: static;">Ep</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card-body">
					<div class="row g-3">
						<div class="col-md-12 text-center">
							<table width="100%" class="table table-striped table-hover" id="T_1">
							  <thead>
...
<script>
  $(document).ready(function() {
  	var table = $('#T_1').DataTable({
  		"data" : [
  			{no : '1', name : 'xxxx xxx', status : 'ปกติ', year : '1'},
  			{no : '2', name : 'xxxx xxx', status : 'ปกติ', year : '2'},
  			{no : '3', name : 'xxxx xxx', status : 'Ep', year : '1'},
  			{no : '4', name : 'xxxx xxx', status : 'ปกติ', year : '1'},
  			{no : '5', name : 'xxxx xxx', status : 'Ep', year : '1'},
  			{no : '6', name : 'xxxx xxx', status : 'ปกติ', year : '1'},
  			{no : '7', name : 'xxxx xxx', status : 'ปกติ', year : '1'},
  			{no : '8', name : 'xxxx xxx', status : 'Ep', year : '2'},
  			{no : '9', name : 'xxxx xxx', status : 'Ep', year : '2'},
  			{no : '10', name : 'xxxx xxx', status : 'ปกติ', year : '4'},
  			{no : '11', name : 'xxxx xxx', status : 'ปกติ', year : '4'},
  			{no : '12', name : 'xxxx xxx', status : 'Ep', year : '2'},
  			{no : '13', name : 'xxxx xxx', status : 'ปกติ', year : '1'},
  			{no : '14', name : 'xxxx xxx', status : 'ปกติ', year : '3'},
  			{no : '15', name : 'xxxx xxx', status : 'ปกติ', year : '1'},
  			{no : '16', name : 'xxxx xxx', status : 'Ep', year : '3'},
  			{no : '17', name : 'xxxx xxx', status : 'Ep', year : '1'},
  			{no : '18', name : 'xxxx xxx', status : 'ปกติ', year : '1'},
  			{no : '19', name : 'xxxx xxx', status : 'Ep', year : '2'},

  			],
  		columns: [
            { data: 'no', title: '#' },
            { data: 'name', title: 'ชื่อ - สกุล' },
            { data: 'status', title: 'ประเภทการศึกษา' },
