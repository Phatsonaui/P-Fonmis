...
<div class="col-md-12 text-center d-none">
  <span ><?php echo "ปีงบประมาณที่ : <b>" .$year_tri. "</b>" . $trimas ."</b> ของเดือน : <b>". DateThaiMonth($month). "</b> มีทั้งหมด : <h3 class='fw-bold mt-2'>" .$sum." โครงการ</h3> จากโครงการทั้งหมด : ".$cou_pro." โครงการ";?></span>
</div>
<div class="col-md-12">
  <table class="table" id="dtBasicExample">
    ...
    <tbody class="Table_body_nu">
        <?php 
          ...
          $db6->Table = "proj_list";
          $db6->Where = "where project_id IN('$project_ids_string') AND project_id <> '000000000000014' order by project_id";
          $user6 = $db6->Select();
            
            foreach ($user6 as $values6 => $data6) {$r++; 
              ...
              foreach ($userdate1 as $valuesdate1 => $datadate1) {$date_cre = $datadate1['prodate_start'];}
              ?>
              <tr>
