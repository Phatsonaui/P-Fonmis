...
<script>
  $(document).ready(function() {
  	var table = $('#T_1').DataTable({
  		"data" : [
  			{no : '1', name : 'xxxx xxx',   year : '1'},
  			{no : '2', name : 'xxxx xxx',   year : '2'},
  			{no : '3', name : 'xxxx xxx',   year : '1'},
  			{no : '4', name : 'xxxx xxx',   year : '1'},
  			{no : '5', name : 'xxxx xxx',   year : '1'},
  			{no : '6', name : 'xxxx xxx',   year : '1'},
  			{no : '7', name : 'xxxx xxx',   year : '1'},
  			{no : '8', name : 'xxxx xxx',   year : '2'},
  			{no : '9', name : 'xxxx xxx',   year : '2'},
  			{no : '10', name : 'xxxx xxx',  year : '3'},
  			{no : '11', name : 'xxxx xxx',  year : '3'},
  			{no : '12', name : 'xxxx xxx',  year : '2'},
  			{no : '13', name : 'xxxx xxx',  year : '1'},
  			{no : '14', name : 'xxxx xxx',  year : '3'},
  			{no : '15', name : 'xxxx xxx',  year : '1'},
  			{no : '16', name : 'xxxx xxx',  year : '3'},
  			{no : '17', name : 'xxxx xxx',  year : '1'},
  			{no : '18', name : 'xxxx xxx',  year : '1'},
  			{no : '19', name : 'xxxx xxx',  year : '2'},
...
console.log(status_1);
      ...
      table.column(2).search(status_1.join('|'), true, false).draw();
      table.draw();
});
  });
	</script>